...
class IGDBBearer {
  ...
  IGDBBearer.fromJson(Map<String, dynamic> json)
...
//
//     final igdbGetGamesList = igdbGetGamesListFromJson(jsonString);
// To parse this JSON data, do
//
//     final igdbGetGamesList = igdbGetGamesListFromJson(jsonString);
...
// List<IgdbGetGamesList> igdbGetGamesListFromJson(String str) =>
//     List<IgdbGetGamesList>.from(
//         json.decode(str).map((x) => IgdbGetGamesList.fromJson(x)));

// String igdbGetGamesListToJson(List<IgdbGetGamesList> data) =>
//     json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

// class IgdbGetGamesList {
//   int id;
//   Cover? cover;
...
//   factory IgdbGetGamesList.fromJson(Map<String, dynamic> json) =>
//       IgdbGetGamesList(
//         id: json["id"],
...
//             ? []
//             : List<AlternativeName>.from(json["alternative_names"]!
//                 .map((x) => AlternativeName.fromJson(x))),
//       );
...
//             ? []
//             : List<dynamic>.from(alternativeNames!.map((x) => x.toJson())),
//       };
// }
...
class Dlc {
  ...
  factory Dlc.fromJson(Map<String, dynamic> json) => Dlc(
        ...
        ageRatings: json["age_ratings"] == null
            ? []
            : List<int>.from(json["age_ratings"]!.map((x) => x)),
        artworks: json["artworks"] == null
            ? []
            : List<int>.from(json["artworks"]!.map((x) => x)),
        category: json["category"],
        cover: json["cover"],
        createdAt: json["created_at"],
        externalGames: json["external_games"] == null
            ? []
            : List<int>.from(json["external_games"]!.map((x) => x)),
        firstReleaseDate: json["first_release_date"],
        gameModes: json["game_modes"] == null
            ? []
            : List<int>.from(json["game_modes"]!.map((x) => x)),
        genres: json["genres"] == null
            ? []
            : List<int>.from(json["genres"]!.map((x) => x)),
        involvedCompanies: json["involved_companies"] == null
            ? []
            : List<int>.from(json["involved_companies"]!.map((x) => x)),
        name: json["name"],
        parentGame: json["parent_game"],
        platforms: json["platforms"] == null
            ? []
            : List<int>.from(json["platforms"]!.map((x) => x)),
        playerPerspectives: json["player_perspectives"] == null
            ? []
            : List<int>.from(json["player_perspectives"]!.map((x) => x)),
        releaseDates: json["release_dates"] == null
            ? []
            : List<int>.from(json["release_dates"]!.map((x) => x)),
        screenshots: json["screenshots"] == null
            ? []
            : List<int>.from(json["screenshots"]!.map((x) => x)),
        similarGames: json["similar_games"] == null
            ? []
            : List<int>.from(json["similar_games"]!.map((x) => x)),
        slug: json["slug"],
        summary: json["summary"],
        tags: json["tags"] == null
            ? []
        ...
        themes: json["themes"] == null
            ? []
            : List<int>.from(json["themes"]!.map((x) => x)),
        updatedAt: json["updated_at"],
        url: json["url"],
        websites: json["websites"] == null
            ? []
            : List<int>.from(json["websites"]!.map((x) => x)),
        checksum: json["checksum"],
        languageSupports: json["language_supports"] == null
            ? []
            : List<int>.from(json["language_supports"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "age_ratings": ageRatings == null
            ? []
            : List<dynamic>.from(ageRatings!.map((x) => x)),
        "artworks":
            artworks == null ? [] : List<dynamic>.from(artworks!.map((x) => x)),
        "category": category,
        "cover": cover,
        "created_at": createdAt,
        "external_games": externalGames == null
            ? []
            : List<dynamic>.from(externalGames!.map((x) => x)),
        "first_release_date": firstReleaseDate,
        "game_modes": gameModes == null
            ? []
            : List<dynamic>.from(gameModes!.map((x) => x)),
        "genres":
            genres == null ? [] : List<dynamic>.from(genres!.map((x) => x)),
        "involved_companies": involvedCompanies == null
            ? []
            : List<dynamic>.from(involvedCompanies!.map((x) => x)),
        "name": name,
        "parent_game": parentGame,
        "platforms": platforms == null
            ? []
            : List<dynamic>.from(platforms!.map((x) => x)),
        "player_perspectives": playerPerspectives == null
            ? []
            : List<dynamic>.from(playerPerspectives!.map((x) => x)),
        "release_dates": releaseDates == null
            ? []
            : List<dynamic>.from(releaseDates!.map((x) => x)),
        "screenshots": screenshots == null
            ? []
            : List<dynamic>.from(screenshots!.map((x) => x)),
        "similar_games": similarGames == null
            ? []
            : List<dynamic>.from(similarGames!.map((x) => x)),
        "slug": slug,
        "summary": summary,
        ...
        "checksum": checksum,
        "language_supports": languageSupports == null
            ? []
            : List<dynamic>.from(languageSupports!.map((x) => x)),
      };
}
...
class ReleaseDate {
  ...
  factory ReleaseDate.fromJson(Map<String, dynamic> json) => ReleaseDate(
        ...
        platform: json["platform"] == null
            ? null
            : GameMode.fromJson(json["platform"]),
      );
...
class Platform {
  ...
  factory Platform.fromJson(Map<String, dynamic> json) => Platform(
        ...
        versions: json["versions"] == null
            ? []
            : List<int>.from(json["versions"].map((x) => x)),
        websites: json["websites"] == null
            ? []
            : List<int>.from(json["websites"]!.map((x) => x)),
        checksum: json["checksum"],
        generation: json["generation"],
        platformFamily: json["platform_family"],
        summary: json["summary"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "url": url,
        "versions":
            versions == null ? [] : List<dynamic>.from(versions!.map((x) => x)),
        "websites":
            websites == null ? [] : List<dynamic>.from(websites!.map((x) => x)),
        "checksum": checksum,
...
class InvolvedCompany {
  ...
  factory InvolvedCompany.fromJson(Map<String, dynamic> json) =>
      InvolvedCompany(
        id: json["id"],
        company:
            json["company"] == null ? null : GameMode.fromJson(json["company"]),
        createdAt: json["created_at"],
...
class ParentGame {
  ...
  factory ParentGame.fromJson(Map<String, dynamic> json) => ParentGame(
        ...
        alternativeNames: json["alternative_names"] == null
            ? []
            : List<int>.from(json["alternative_names"]!.map((x) => x)),
        category: json["category"],
        ...
        keywords: json["keywords"] == null
            ? []
            : List<int>.from(json["keywords"]!.map((x) => x)),
        name: json["name"],
        platforms: json["platforms"] == null
            ? []
            : List<int>.from(json["platforms"]!.map((x) => x)),
        ...
        videos: json["videos"] == null
            ? []
            : List<int>.from(json["videos"]!.map((x) => x)),
        websites: json["websites"] == null
            ? []
            : List<int>.from(json["websites"]!.map((x) => x)),
        checksum: json["checksum"],
        ports: json["ports"] == null
            ? []
            : List<int>.from(json["ports"]!.map((x) => x)),
        gameLocalizations: json["game_localizations"] == null
            ? []
            : List<int>.from(json["game_localizations"]!.map((x) => x)),
        collections: json["collections"] == null
            ? []
            : List<int>.from(json["collections"]!.map((x) => x)),
        ageRatings: json["age_ratings"] == null
            ? []
            : List<int>.from(json["age_ratings"]!.map((x) => x)),
        ...
        franchises: json["franchises"] == null
            ? []
            : List<int>.from(json["franchises"]!.map((x) => x)),
        gameModes: json["game_modes"] == null
            ? []
            : List<int>.from(json["game_modes"]!.map((x) => x)),
        ...
        remakes: json["remakes"] == null
            ? []
            : List<int>.from(json["remakes"]!.map((x) => x)),
        languageSupports: json["language_supports"] == null
            ? []
            : List<int>.from(json["language_supports"]!.map((x) => x)),
        artworks: json["artworks"] == null
        ...
        multiplayerModes: json["multiplayer_modes"] == null
            ? []
            : List<int>.from(json["multiplayer_modes"]!.map((x) => x)),
        rating: json["rating"]?.toDouble(),
        ratingCount: json["rating_count"],
        bundles: json["bundles"] == null
            ? []
            : List<int>.from(json["bundles"]!.map((x) => x)),
        storyline: json["storyline"],
        parentGame: json["parent_game"],
        expandedGames: json["expanded_games"] == null
            ? []
            : List<int>.from(json["expanded_games"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "game_localizations": gameLocalizations == null
            ? []
            : List<dynamic>.from(gameLocalizations!.map((x) => x)),
        ...
        "franchises": franchises == null
            ? []
            : List<dynamic>.from(franchises!.map((x) => x)),
        "game_modes": gameModes == null
            ? []
            : List<dynamic>.from(gameModes!.map((x) => x)),
        ...
        "remakes":
            remakes == null ? [] : List<dynamic>.from(remakes!.map((x) => x)),
        "language_supports": languageSupports == null
            ? []
            : List<dynamic>.from(languageSupports!.map((x) => x)),
        "artworks":
            artworks == null ? [] : List<dynamic>.from(artworks!.map((x) => x)),
        "hypes": hypes,
        "multiplayer_modes": multiplayerModes == null
            ? []
            : List<dynamic>.from(multiplayerModes!.map((x) => x)),
        "rating": rating,
        "rating_count": ratingCount,
        "bundles":
            bundles == null ? [] : List<dynamic>.from(bundles!.map((x) => x)),
        "storyline": storyline,
        "parent_game": parentGame,
        "expanded_games": expandedGames == null
            ? []
            : List<dynamic>.from(expandedGames!.map((x) => x)),
      };
}
...
// To parse this JSON data, do
//
//     final getListOfPlatformsResponse = getListOfPlatformsResponseFromJson(jsonString);

// List<GetListOfPlatformsResponse> getListOfPlatformsResponseFromJson(
//         String str) =>
//     List<GetListOfPlatformsResponse>.from(
//         json.decode(str).map((x) => GetListOfPlatformsResponse.fromJson(x)));

// String getListOfPlatformsResponseToJson(
//         List<GetListOfPlatformsResponse> data) =>
//     json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

// class GetListOfPlatformsResponse {
//   int id;
//   String? abbreviation;
//   String name;
//   PlatformLogo? platformLogo;
...
//   factory GetListOfPlatformsResponse.fromJson(Map<String, dynamic> json) =>
//       GetListOfPlatformsResponse(
//         id: json["id"],
//         abbreviation: json["abbreviation"],
//         name: json["name"],
...
//             ? []
//             : List<dynamic>.from(websites!.map((x) => x.toJson())),
//       };
// }
...
class IgdbGetGamesList {
  ...
  factory IgdbGetGamesList.fromJson(Map<String, dynamic> json) =>
      IgdbGetGamesList(
        ...
        themes: json["themes"] == null
            ? []
            : List<GameMode>.from(
                json["themes"]!.map((x) => GameMode.fromJson(x))),
        url: json["url"],
        genres: json["genres"] == null
            ? []
            : List<GameMode>.from(
                json["genres"]!.map((x) => GameMode.fromJson(x))),
        gameModes: json["game_modes"] == null
            ? []
            : List<GameMode>.from(
        ...
        involvedCompanies: json["involved_companies"] == null
            ? []
            : List<InvolvedCompany>.from(json["involved_companies"]!
                .map((x) => InvolvedCompany.fromJson(x))),
        parentGame: json["parent_game"] == null
            ? null
            : ParentGame.fromJson(json["parent_game"]),
        summary: json["summary"],
        videos: json["videos"] == null
            ? []
        ...
        playerPerspectives: json["player_perspectives"] == null
            ? []
            : List<Keyword>.from(
                json["player_perspectives"]!.map((x) => Keyword.fromJson(x))),
        artworks: json["artworks"] == null
            ? []
            : List<Cover>.from(json["artworks"]!.map((x) => Cover.fromJson(x))),
        storyline: json["storyline"],
        ...
        gameLocalizations: json["game_localizations"] == null
            ? []
            : List<GameLocalization>.from(json["game_localizations"]!
                .map((x) => GameLocalization.fromJson(x))),
        alternativeNames: json["alternative_names"] == null
            ? []
            : List<AlternativeName>.from(json["alternative_names"]!
                .map((x) => AlternativeName.fromJson(x))),
        dlcs: json["dlcs"] == null
            ? []
            : List<Dlc>.from(json["dlcs"]!.map((x) => Dlc.fromJson(x))),
        multiplayerModes: json["multiplayer_modes"] == null
            ? []
            : List<MultiplayerMode>.from(json["multiplayer_modes"]!
                .map((x) => MultiplayerMode.fromJson(x))),
        rating: json["rating"]?.toDouble(),
        status: json["status"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "involved_companies": involvedCompanies == null
            ? []
            : List<dynamic>.from(involvedCompanies!.map((x) => x.toJson())),
        ...
        "player_perspectives": playerPerspectives == null
            ? []
            : List<dynamic>.from(playerPerspectives!.map((x) => x.toJson())),
        "artworks": artworks == null
            ? []
            : List<dynamic>.from(artworks!.map((x) => x.toJson())),
        "storyline": storyline,
        ...
        "game_localizations": gameLocalizations == null
            ? []
            : List<dynamic>.from(gameLocalizations!.map((x) => x.toJson())),
        "dlcs": dlcs == null
            ? []
            : List<dynamic>.from(dlcs!.map((x) => x.toJson())),
        "multiplayer_modes": multiplayerModes == null
            ? []
            : List<dynamic>.from(multiplayerModes!.map((x) => x.toJson())),
        "rating": rating,
        "status": status,
      };
}
